...
set :domain, "localhost" # Le SSH de destination
set :deploy_to, "/home/ahaifi/data/test" # Le répertoire de destination
set :app_path, "app" # Le dossier d’application, laissez app
set :user, "ahaifi" # Le nom d’utilisateur du serveur distant
set :password, "123456789" # Le nom d’utilisateur du serveur distant

set :copy_dir, "/home/ahaifi/tmp"
set :remote_copy_dir, "/tmp"

set :repository, "git@github.com:anasstsdi/gripli.git" # L’URL de votre repository
